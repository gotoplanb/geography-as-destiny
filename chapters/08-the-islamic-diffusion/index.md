...
Manichaeism dissolved lines. Mani, a third-century Persian prophet, deliberately designed a religion for maximum cross-cultural adoptability.[^ch8-1][^ch8-2] He incorporated Zoroastrian dualism, Buddhist cosmology, Christian narrative structure, and Gnostic philosophy into a single universal system. He translated his own texts into multiple languages. He built a missionary infrastructure explicitly modeled on what worked in every tradition he absorbed. He was doing product-market-fit optimization for a spiritual system — three centuries before Muhammad.
...
This chapter argues that the outcome was structurally predictable.[^ch8-3] Not because Islam was theologically superior. Not because Muhammad was a greater man than Mani. Because the thermodynamic logic of human social organization selects for boundary-drawing over boundary-dissolving, and the geographic conditions of the seventh-century corridor amplified that selection.

---

## II. Why Boundaries Are Load-Bearing

Friction zones between cultures are not bugs in the human social system. They are load-bearing features.[^ch8-4] The boundary between cultures is where identity gets defined, where group cohesion gets maintained, where the us-versus-them distinction that organizes collective action gets drawn.
...
When Buddhist dharmas were translated into Chinese at Turfan and Dunhuang, the translation project was late-majority adoption infrastructure[^ch8-8] — the compliance apparatus of a religion that had passed its tipping point and needed to serve populations beyond the reach of direct personal transmission.
...
Religion diffuses bottom-up, but it is also deployed top-down, and the two mechanisms are worth holding apart. The clearest self-documented case of the top-down deployment is not Islamic but Mauryan, five centuries before Muhammad. Ashoka, having conquered most of the Indian subcontinent by the sword, pivoted after the bloody conquest of Kalinga around 261 BCE to governance by *Dhamma* — a broadcast civic-ethical code promulgated on rock and pillar edicts across the empire, in local scripts and even in Greek and Aramaic at the Hellenized fringe. He left the reasoning carved in stone, which makes his the rare instrumental-religion move the record does not force us to infer. The logic is the one this chapter reads in the Islam that solved coordination problems for Transoxiana and that the Silk Road chapter reads in the Pax Mongolica's studied religious tolerance: legitimacy is cheaper than coercion. Moral authority is a low-marginal-cost, high-reach holding technology; the sword is expensive and local. A diverse empire bound by a shared civic ethic costs a fraction of one held by garrisons — which is why the move recurs, from Ashoka's Dhamma to Han Confucianism to Mongol tolerance. It is not, however, the whole story of religion and power. Ashoka's own grandfather, Chandragupta, is the genuine exception: he appears to have *abdicated* to become a Jain ascetic — religion overriding statecraft rather than serving it, the rare case the instrumental pattern does not absorb.[^ch8-12]
...
The Gandhara refugees who arrived at Tarim Basin oasis cities came in small groups — a hundred at a time.[^ch8-13] They were absorbed without resistance. The thermodynamic pressure differential was low enough that the host system could integrate the input without defensive reorganization.
...
Then it collapsed. Persecuted simultaneously by every major empire: Byzantine Christianity, Sassanid Persia, Abbasid Islam, Tang China. Only the Uyghur Empire provided sustained political shelter — and when that collapsed in 840 CE, the last protector vanished.[^ch8-14]
...
Another returning bomber. Another receiver-side silence.[^ch8-15]
