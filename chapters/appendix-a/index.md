...
**What would test it further:** Systematic coding of chokepoint-control histories globally against (a) substrate-driven geographic logic producing the chokepoint's significance, (b) specific political-actor transitions affecting control, (c) persistence vs. decline of chokepoint significance across transitions. The framework's prediction is that chokepoints retain significance across political-actor transitions when the substrate-driven geographic logic that produced their significance remains operative; chokepoints decline when substrate conditions change (alternative routes become available; technology changes the underlying friction calculus; specific commercial flows that the chokepoint controlled cease to exist).

**What would falsify it:** Strategically-significant chokepoints systematically losing significance immediately upon political-actor transition; substrate-driven geographic logic systematically failing to operate across political transitions; political-actor changes systematically determining chokepoint significance independent of underlying substrate conditions.
