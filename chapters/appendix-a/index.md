...
- **Central Asian chokepoints across multiple political transitions** — Samarkand, Bukhara, Kashgar retained corridor-significance across Sogdian, Tang-affiliated, various subsequent transitions; declined when the oceanic routes made the overland corridor obsolete (Chapter 4 Section XI) rather than because of any specific political-actor change

**The sender-side encoding artifact pattern:** Chokepoint acquisitions across political-actor transitions systematically generate sender-side encoding of strategic acquisition as moral obligation (per Chapter 6's "encoding work scales with the gap between mechanism and legitimacy" principle). McKinley's prayer story is the canonical clean case at the high end of the encoding-work spectrum — honest articulation of Mahan-doctrine chokepoint logic would have triggered anti-imperialist political mobilization; encoding maintained acquisition support that honest strategic articulation would have undermined.
