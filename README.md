...
A collaborative project between a human with a twenty-year geographic-determinist framework and an AI with access to the breadth of human scholarship. The thesis emerged from dialogue. It was not handed down from either side.

Open access. No institutional affiliation. No paywall. If three anthropology students find it useful, that's enough.

## Status

Early drafting. The outline is solid. The chapters are next.
