...
What the book does intellectually is mash up Diamond and Anthony through Rogers and Shannon, from an anti-eugenic and social-constructionist epistemology. Diamond supplies geographic determinism as the macro framework: terrain and the available domesticates set the probability distributions of civilizational outcomes. Gimbutas and Anthony supply the deep prehistory evidence base — the Kurgan hypothesis developed in the 1950s as explicit rejection of the Aryan race narrative, refined with genetic and archaeological evidence into the dominant academic position on Indo-European origins — anchoring the framework at horse domestication around 4000 BCE on the Pontic-Caspian steppe. Rogers supplies the diffusion mechanism — how innovations and populations spread through networks along predictable curves. Shannon supplies the epistemological apparatus — sender-side encoding contaminating the historical record, receiver-side reconstruction as the methodology. Anti-eugenics positions the framework as the structural opposite of biological determinism: terrain produces different outcomes through different selection pressures across normally-distributed human populations, not biological capacity producing different outcomes across stratified ones. Social constructionism positions the framework's claims epistemically: not the truth about history but a more useful lens, explaining more variance and generating falsifiable predictions. Five traditions in one room. The book is what happens when they start talking.
